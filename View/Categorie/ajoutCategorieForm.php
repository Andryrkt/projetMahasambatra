...
<head>
    ...
    <link rel="stylesheet" href="../../Css/Categorie/ajoutCategorieForm.css">
</head>
...
<body>
    ...
    <h2 class="text-center mt-5">Ajouter une nouvelle Categorie</h2>

    <div class="container p-5 d-flex justify-content-center align-items-center">
        <form action="../../Controller/Categorie/ajoutCategorieController.php" method="post">
            <div class="row">
                <div class="col-12 d-flex align-items-center p-5 custom-col">
                    <input class="form-control form-control-lg  me-2 p-3" type="text" name="ouvelleCategorie" id="ouvelleCategorie" placeholder="Entrez le nom du categorie" required>
