...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-warning border border-5 border-white w-75 p-4 mx-auto">
    ...
    <h2 class="text-center mt-5">Liste des Administrateurs</h2>
                        ...
                        <td class="text-center align-middle rounded-end p-4">
                            <div class="btn-group">
                                ...
                                <div class="action-dropdown rounded-5">
                                    ...
                                    <a href="modifierAdminForm.php?id=<?php echo htmlspecialchars($admin['id']); ?>" class="text-decoration-none">Modifier</a>
                                    </div>
                            </div>
                        </td>
                    </tr>
